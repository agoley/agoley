export class Logs {
  ...
  displayBestDevLifeLog() {
    ...
    blogNode.innerHTML =
      ...
      "<p>Once you have both of these numbers divide the TC by TTI to get your QoL quotient (QoLQ) carry over the annotations for non tangible additions for TC. For example if you have determined TC is 100,000 with an annotation for mentorship (Mn) and TTI is 40 then your QoLQ is (100000/40)Mn, which is 2,500Mn. It takes some work to break down into a QoLQ but the pay off is a formula for comparing offers.</p>" +
