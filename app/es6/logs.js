export class Logs {
  ...
  displayNikeInvincibleFlynitReviewLog() {
    ...
    blogNode1.innerHTML =
      "<p style='font-size: 24px;'><b>TL;DR</b> 🏃‍♂️🏃‍♂️🏃‍♂️🏃‍♂️ (4/5) Strides. There's not much dislike with the Nike ZoomX Invincible Run Flyknit. I deducted a stride for stability and style, but these deliver what I want from an every day running shoe.</p>" +
      '<p>Nike claims this is "one of our most tested shoes" and offers a cushioned Flynit upper on top of a luxurious full length bed of ZoomX foam. By design it promises to be a great daily runner meant to go easy on your knees for long runs on hard surfaces. I personally was looking for maximum support to cut down on my recovery days and up my weekly mileage. So does this shoe actually deliver?</p>' +
      "<p>After seeing the marketing for the Nike ZoomX Invincible Run Flyknit I was hooked by the ample ZoomX cushioning and was anticipating giving them a try as my pegasus turbo 2 where starting to reach their end of life. I ordered them from the Nike app on March 15th, and received them a week later on March 22nd. Since then I have put about 50 miles on them in various conditions and surfaces and feel I have a good understanding of what these deliver. Below I will rate the attributes I look for in a running shoe and give an overall score.</p>" +
    ...
    blogNode3.innerHTML =
      ...
      "<p>Look good, run good. These aren’t they type of runners that can double as streetwear like Addidas Ultraboosts. For a daily runner I think they look fine. There are three color ways at the time of writing this, I like the white/racer blue.</p>" +
      "<p style='font-size: 24px;'><b>Verdict</b></p>" +
      "<p>🏃‍♂️🏃‍♂️🏃‍♂️🏃‍♂️ (4/5) Strides</br></br> There's not much dislike with the Nike ZoomX Invincible Run Flyknit. I deducted a stride for stability and style, but these deliver what I want from an every day running shoe. </p>";
