export class Logs {
  ...
  displayNikeInvincibleFlynitReviewLog() {
    ...
    blogNode1.innerHTML =
      ...
      '<p>Nike claims this is "one of our most tested shoes" and offers a cushioned Flynit upper on top of a luxurious full length bed of ZoomX foam. By design it promises to be a great daily runner, meant to go easy on your knees for long runs on hard surfaces.</p>' +
      "<p>After seeing the marketing for the Nike ZoomX Invincible Run Flyknit, I was hooked by the ample ZoomX cushioning and was anticipating giving them a try as my pegasus turbo 2 where starting to reach their end of life. I ordered from the Nike app on March 15th, and received them a week later on March 22nd.</p>" +
    ...
    blogNode2.innerHTML =
      ...
      "<p>My initial impression after walking was that stability would be a problem. There is so much responsiveness that it feels like I could easily roll an ankle. I would warn that if you intend on walking a lot in them, they might not be the best option. However once you get moving, my concerns about stability were left behind. At a jog they become much more stable. Also as I broke them in they became more stable.</p>" +
      "<p style='font-size: 24px;'><b>Comfort</b></p>" +
      "<p>If you have ever worn a Flynit shoe, you know that the upper is very soft and breathable. With added padding around the ankle I haven’t experienced any chafing. Under foot these are extremely soft, and your foot will sink into the foam just slightly.</p>" +
      "<p style='font-size: 24px;'><b>Traction</b></p>" +
      "<p>Traction is fine. Down steep hills, and around tight corners in the rain I haven’t experienced any slipping. Also the traction feels like new at the ~50 mi mark.</p>" +
    ...
    blogNode3.innerHTML =
      ...
      "<p>These aren’t the type of runners that can double as streetwear. However, for a daily runner I think they look fine. There are three color ways at the time of writing this, I like the white/racer blue.</p>" +
