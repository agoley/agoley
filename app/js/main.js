...
var Logs = /*#__PURE__*/function () {
  ...
  _createClass(Logs, [{
    ...
    value: function displayNikeInvincibleFlynitReviewLog() {
      ...
      blogNode1.innerHTML = "<p style='font-size: 24px;'><b>TL;DR</b> 🏃‍♂️🏃‍♂️🏃‍♂️🏃‍♂️ (4/5) Strides. There's not much dislike with the Nike ZoomX Invincible Run Flyknit. I deducted a stride for stability and style, but these deliver what I want from an every day running shoe.</p>" + '<p>Nike claims this is "one of our most tested shoes" and offers a cushioned Flynit upper on top of a luxurious full length bed of ZoomX foam. By design it promises to be a great daily runner meant to go easy on your knees for long runs on hard surfaces. I personally was looking for maximum support to cut down on my recovery days and up my weekly mileage. So does this shoe actually deliver?</p>' + "<p>After seeing the marketing for the Nike ZoomX Invincible Run Flyknit I was hooked by the ample ZoomX cushioning and was anticipating giving them a try as my pegasus turbo 2 where starting to reach their end of life. I ordered them from the Nike app on March 15th, and received them a week later on March 22nd. Since then I have put about 50 miles on them in various conditions and surfaces and feel I have a good understanding of what these deliver. Below I will rate the attributes I look for in a running shoe and give an overall score.</p>" + "<p style='font-size: 24px;'><b>Responsiveness</b></p>" + "<p>Just from looking at these you might have high expectations for the responsiveness. The shoe sits on a luxuriant ZoomX midsole measuring (2 in) tall by (4.25 in) wide at the mid heel and (1.5 in) tall by (5.5 in) wide at the forefoot. Before even hitting the pavement in these I could tell these were different just from trying them on. The initial feeling is a forward leaning bounce that makes me want to get on a track and go. Some other shoes have a bounce to them but from my experience these are in a class of their own. I even tried them on in a gym out of curiosity and these add an extra (3 - 5 in) to my vertical as compared to my usual Jordan 14's (Zoom unit forefoot). After taking them to the pavement I can confirm that the responsiveness is great and the feeling persists for the entire run. </p>";
      var blogNode2 = document.createElement("div");
      blogNode2.style.maxWidth = "800px";
      blogNode2.innerHTML = "<p style='font-size: 24px;'><b>Stability</b></p>" + "<p>My initial impression after putting these on and walking was that stability would be a problem, there is so much responsiveness that just walking around feels like I could easily roll an ankle. I would actually warn that if you intend on walking a lot in them, they might not be the best option. However once you get moving, my concerns about stability were left behind. Once at a jog they become much more stable. Also as I broke them in I felt like they became more stable.</p>" + "<p style='font-size: 24px;'><b>Comfort</b></p>" + "<p>If you ever worn a Flynit shoe you know that the upper of these is very soft and breathable, however these don’t stop there, with added padding around the ankle I haven’t experienced any chaffing around the ankle. Under foot these are extremely soft and the your foot will sink into the foam just slightly.</p>" + "<p style='font-size: 24px;'><b>Traction</b></p>" + "<p>Traction on these is fine. Down steep hills, and around tight corners in the rain I haven’t experienced any slipping. Also the traction still feels like new at the ~50 mi mark.</p>" + "<p style='font-size: 24px;'><b>Speed</b></p>" + "<p>They’re surprisingly light with all the foam and added padding in the upper. Combine the responsiveness with a decent drop (0.5 in) from heel to toe these will propel you forward. There is no plate in the sole just 100% foam. These aren’t designed for speed but for a max comfort shoe they won’t hurt your pace much if you decided to pick it up.</p>";
      var blogNode3 = document.createElement("div");
      blogNode3.style.maxWidth = "800px";
      blogNode3.innerHTML = "<p style='font-size: 24px;'><b>Style</b></p>" + "<p>Look good, run good. These aren’t they type of runners that can double as streetwear like Addidas Ultraboosts. For a daily runner I think they look fine. There are three color ways at the time of writing this, I like the white/racer blue.</p>" + "<p style='font-size: 24px;'><b>Verdict</b></p>" + "<p>🏃‍♂️🏃‍♂️🏃‍♂️🏃‍♂️ (4/5) Strides</br></br> There's not much dislike with the Nike ZoomX Invincible Run Flyknit. I deducted a stride for stability and style, but these deliver what I want from an every day running shoe. </p>";
