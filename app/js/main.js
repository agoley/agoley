...
var Logs = exports.Logs = function () {
  ...
  _createClass(Logs, [{
    ...
    value: function displayBestDevLifeLog() {
      ...
      var blogNode = document.createElement("div");
      blogNode.style.maxWidth = "800px";
      blogNode.innerHTML = "<p style='font-size: 24px;'><b>Disclaimer</b> Use your best judgment when making career decisions.</p>" + "<p style='font-size: 24px;'><b>TL;DR</b> As a developer know your value and be willing to negotiate with employers to achieve your best quality of life.</p>" + "<p>In this article I try to make sense of the developer job market in the US. With over 3.7 million tech jobs posted in 2018  it can seem like chaos. I often lurk on r/cscareerquestions and see developers with ranging levels of skill and experience looking for advice about the job market. For the most part we are all looking for the best quality of life (QoL) we can find in a job. I Define QoL as the intersection of total compensation (TC) and total time invested (TTI) in the job. I believe that for a developer to reach their maximum QOL they must; 1. know their value, 2. demonstrate their value to employers, and 3. negotiate and or change jobs. Below I'll share my experiences on how to accomplish each of these steps, how to increase your value, and explain further how to compare jobs.</p>" + "<p class='accent' style='font-size: 24px;'><i>\"3.7 million tech jobs posted in 2018\"</i></p>" + "<p style='font-size: 24px;'><b>1. Calculating QoL </b></p>" + "<p>Gather up your offer letters, benefits brochures, and coffee. First determine what the total compensation (TC) is by summing up every dollar spent on you by the employer. Add up pay, stock awards, benefits, retirement, HSA, bonuses, and anything else that the employer may offer. I also like to consider intangibles, things like mentorship, or training that you can't put a dollar amount on. Keep them in mind by annotating the TC with notes on intangible offerings.</p>" + '<p>Next determine the total time invested (TTI), which is what I call the average number of hours per week that will be spent on work or work related functions. This is more than the 40hrs or whatever that you will be expected to be "on the clock". Be sure to include travel time, any required training that you may be expected to do off hours, events, time to research if you think you will need to be playing "catch-up",  business development activities, and last but not least "de-stress time" which is what I call the time needed to wind down from a days work.</p>' + "<p>Once you have both of these numbers divide the TC by TTI to get your QoL quotient (QoLQ) carry over the annotations for non tangible additions for TC. For example if you have determined TC is 100,000 with an annotation for mentorship (Mn) and TTI is 40 then your QoLQ is (100/40)Mn, which is 2,500Mn. It takes some work to break down into a QoLQ but the pay off is a formula for comparing offers.</p>" + "<p style='font-size: 24px;'><b>2. Know Your Value </b></p>" + "<p>This one seems obvious, but due to the stigma about sharing pay information in the office, if you don't do a little research you risk not knowing what others with similar expierience, skills, and location are getting paid. The easiest thing to do here is ask your peers, the more the better, what their compensation is. If you feel uncomfotable asking, or you don't have anyone to ask, go online to forums like r/cscareerquestions and post asking others. Important factors to consider are; location, salary, PTO, and benefits.  </p>" + "<p style='font-size: 24px;'><b>3. Demonstrate Value </b></p>" + "<p>Employers will be a lot more open to negotiating when you have clearly demonstrated the value that you can provide. There are many ways to demonstrate value, but regardless of your skills, you want to have a documented track record of delivering on them. For example if you are a high velocity developer, you want to have something that you can point to and say \"I accomplished X, Y, and Z before the product deadline\". If you are more of a technical leader, you want to have a history of projects that you have lead to sucess with tangible results, like positive feedback from customers, or insentive bonuses met. You're selling yourself,  a proven track record speaks louder than words, or (IMO) a technical interview. If you don't have these things you should start working on them! </p>" + "<p class='accent' style='font-size: 24px;'><i>\"you want to have a documented track record of delivering\"</i></p>" + "<p style='font-size: 24px;'><b>4. Negotiate </b></p>" + "<p>Once you know your value, and have demonstrated it, you are in good shape to go get your maximum QoL job. This is the easy part, if you are happy with your current employer begin a negotiation process by letting your manager know what it is you believe your compensation should be, and use your track record of demonstrating value as leverage. If you would like to test the market,  get your resume out there and let the offers role in! Armed with your research of the market and your demonstrated value be upfront with prospective employers about what you are looking for and why you are worth it. </p>";
